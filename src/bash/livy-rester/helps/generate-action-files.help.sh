# src/bash/livy-rester/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/livy-rester/helps/generate-action-files.help.txt
...
# eof file: src/bash/livy-rester/funcs/generate-action-files.help.sh
